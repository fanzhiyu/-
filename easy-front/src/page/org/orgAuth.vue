      ...
      methods: {
        ...
        initTree(data){
          ...
          $('#tree').on("loaded.jstree",function(e,data){
            ...
            var param = {};
            console.log()
            param['orgId'] = $this.$parent.params.orgId;
            $this.$httpService.getMenuByOrgId(param).then((res)=>{
        ...
        confirm(){
          ...
          var param = {};
          var json = {};
          json['orgId'] = this.$parent.params.orgId;
          json['list'] = sel;
          param['params'] = JSON.stringify(json);
          this.$httpService.saveOrgMenu(param).then((res)=>{
            if(res.code == '2000'){
              this.$parent.close();
            }
          });
